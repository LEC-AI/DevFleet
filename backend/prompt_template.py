def build_prompt(mission: dict, last_report: dict | None = None) -> str:
    ...
    parts += [
        ...
        "",
        "- **next_steps**: Specific, actionable recommendations for the NEXT mission/agent based on",
        "  the overall project goals. Frame as mission titles if possible.",
        ...
        "  Flag anything that requires manual intervention — permission issues, sudo commands,",
        "  API keys needed, services that need to be started, DNS changes, etc.",
